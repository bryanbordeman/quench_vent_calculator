from calculator.constants import (
    TUBE_TYPES, COEFFICIENTS_LESS_EQUAL_200, 
    COEFFICIENTS_GREATER_200, FITTING_PARAMETERS, LENGTH_MULTIPLIERS
)

class BaseElement:
    def __init__(self, diameter, element_type):
...
class Element(BaseElement):
    def __init__(self, diameter, length=0, angle=None, type=None, element_type=None):
        if angle and type:
    ...
    def calculate_pressure(self, previous_pressure_drop, length_so_far, n):
        ...
        # print("pressure_drop", element_pressure_drop)
